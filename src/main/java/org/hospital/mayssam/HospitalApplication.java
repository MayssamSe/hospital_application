...
import org.hospital.mayssam.security.service.AccountService;
...
public class HospitalApplication implements CommandLineRunner {
    ...
    public void run(String ...args) throws Exception{
        ...
        patientRepository.save(new Patient(null,"mayssam",new Date(),false,34));
